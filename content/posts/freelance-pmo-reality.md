...
{{< cta-box eyebrow="フリーランス転向を検討している方へ" title="**フリーランスPMO向けエージェント**に案件を聞いてみる" body="PMO・PM案件を多く扱うエージェントに登録して、自分のスキルが市場でどう評価されるか確認しましょう。転向するかどうかはその後決めればOKです。" cta_url="#" cta_label="🎯 レバテックフリーランスで案件を探す" note="※ 登録・相談は無料です。" >}}{{< /cta-box >}}
