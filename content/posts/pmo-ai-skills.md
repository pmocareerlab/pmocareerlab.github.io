...
{{< cta-box eyebrow="AIスキルを体系的に学びたい方へ" title="**生成AI×ビジネス活用**を学ぶ" body="ChatGPTなどの生成AIをビジネスで活用するスキルを体系的に学べるスクールが増えています。PMO業務への応用に特化したカリキュラムで、実務で使えるレベルまで習得できます。" cta_url="#" cta_label="🤖 DMM生成AICAMPを見てみる" note="※ 無料カウンセリングあり。受講前に相談できます。" >}}{{< /cta-box >}}
