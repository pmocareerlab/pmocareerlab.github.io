...
{{< cta-box eyebrow="コンサル転職を検討している方へ" title="**コンサル特化エージェント**に登録しておく" body="コンサル転職は「どのエージェントを使うか」で求人の質と面接サポートの深さが変わります。PMO出身者の転職実績が豊富な特化型エージェントを、まず1〜2社は確保しておきましょう。" cta_url="#" cta_label="🎯 コンサル特化エージェントを見る" note="※ 登録・相談は無料。求人確認だけでもOKです。" >}}{{< /cta-box >}}
...
{{< cta-box eyebrow="事業会社・情シスへの転職を考えている方へ" title="**スカウト型サービス**で市場価値を測る" body="PMO経験者は事業会社から一定のニーズがあります。ビズリーチやリクルートダイレクトスカウトに登録するだけで、どんな企業からオファーが来るかがわかります。転職意欲がまだ固まっていなくてもOK。" cta_url="#" cta_label="📊 まずスカウト登録してみる" note="※ スカウトを受け取るだけなら、転職活動を始めたことにはなりません。" >}}{{< /cta-box >}}
...
{{< cta-box eyebrow="フリーランス転向を検討している方へ" title="**フリーランスPMO向けエージェント**に案件を聞いてみる" body="登録して「今PMO案件はどのくらいありますか？」と聞くだけでも、市場の実態がわかります。転向するかどうかは、その後ゆっくり決めれば問題ありません。" cta_url="#" cta_label="🎯 フリーランスPMO案件を見る" note="※ 登録・問い合わせは無料です。" >}}{{< /cta-box >}}
...
{{< ranking-box rank="1" title="ビズリーチ" tagline="まず「自分の市場価値」を知るのに最適" rating="4.5" summary="スカウト型なので、受け取ったオファーを見るだけで年収相場がわかります。転職意欲がゆるくても使えるのが強み。PMOポジションのスカウトも届きます。" cta_url="#" cta_label="無料で登録する" >}}

{{< ranking-box rank="2" title="コンコード エグゼクティブ" tagline="コンサル転職を本気で狙うなら必須" rating="4.7" summary="コンサル転職特化の老舗。PMO出身者の転職実績が豊富で、ケース面接の対策サポートまでしてくれる担当者が多い。コンサルルートを検討しているなら最優先で登録すべき1社。" cta_url="#" cta_label="無料で相談する" >}}

{{< ranking-box rank="3" title="レバテックフリーランス" tagline="フリーランスPMO転向を考えているなら" rating="4.3" summary="IT系フリーランス案件に強いエージェント。PMO案件の取扱い数が多く、単価感・案件の種類を具体的に教えてもらえます。独立前の情報収集先として有効。" cta_url="#" cta_label="無料で案件を見る" >}}
